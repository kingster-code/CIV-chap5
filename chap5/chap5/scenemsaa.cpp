...
{
	try {
    	prog.compileShader("C:/Users/danny/source/repos/chap5/chap5/things/shader/centroid.vs");
    	prog.compileShader("C:/Users/danny/source/repos/chap5/chap5/things/shader/centroid.fs");
    	prog.link();
    	prog.use();
