...
{
  try {
    prog.compileShader("C:/Users/danny/source/repos/chap5/chap5/things/shader/oit.vs");
    prog.compileShader("C:/Users/danny/source/repos/chap5/chap5/things/shader/oit.fs");
    prog.link();
    prog.use();
